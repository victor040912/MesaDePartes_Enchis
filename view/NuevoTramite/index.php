                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        <label for="choices-single-default" class="form-label font-size-13 text-muted">Area</label>
                                                        <select class="form-control" data-trigger="" name="area:nom" id="area_id" placeholder="Seleccionar">
